...
/// <summary>
/// Compass used to track opponents position in 3D space.
/// </summary>
public class HUDOpponentsPosition : MonoBehaviour
{
    ...
    private Dictionary<Transform, GameObject> positionShipAndIndicators = new Dictionary<Transform, GameObject>();
    private Dictionary<GameObject, TextMesh> textMeshes = new Dictionary<GameObject, TextMesh>();

    // Use this for initialization
    void Start ()
    {
        myShipPosition = transform;     // TEMP
